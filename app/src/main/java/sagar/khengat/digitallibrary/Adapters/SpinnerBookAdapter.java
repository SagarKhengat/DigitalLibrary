...
public class SpinnerBookAdapter extends ArrayAdapter<Book> {
    ...
    public SpinnerBookAdapter(Context context, int textViewResourceId,
                                 List<Book> values) {
...
//        return label;
        ...
        Book area = values.get(position);
        txtTitle.setText(area.getBookId());
